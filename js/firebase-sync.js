...
window.defaultBlueprintTasksMahi = [
    ...
    { id: "gf-leave-wed-3", date: "Wednesday, May 27", phase: "Study Leave", subject: "eng", time: "Evening (6PM-7:30PM)", title: "English Paper 2: Reading & Analysis Notes", desc: "Read key chapters, analyze both books side-by-side, and take down comparative notes on major themes (isolation, class, or betrayal).", completed: false },
